...
create_json_template <- function(plot_data_names, file_name, default_variable_type="") {
  ...
  for (name in plot_data_names) {
    names_list[[ name ]] <- list(variableType=default_variable_type)
  }
...
create_json_template(names(Climate_Plot_data), "climate_lookup_functions.json", "quantitative")
...
humus_lookup_functions <- fromJSON(file="lookup_functions/humus_lookup_functions.json")
mineral_lookup_functions <- fromJSON(file="lookup_functions/mineral_lookup_functions.json")
climate_lookup_functions <- fromJSON(file="lookup_functions/climate_lookup_functions.json")
admin_lookup_functions <- fromJSON(file="lookup_functions/admin_lookup_functions.json")
```
...
create_veg_report_data <- function(VegR_by_plot_numbers_in_level, species_data_by_plot_number) {
