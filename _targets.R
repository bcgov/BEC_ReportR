...
#   strip.white = TRUE,
#   sep = ',',
#   file = file.path("level_name_value.csv")
# )

# for( i in rownames(level_values) ) {
#   print(level_values[i, "name"])
#   print(level_values[i, "value"])
#   
#   level.name <- level_values[i, "name"]
#   level.value <- level_values[i, "value"]
# }
# 
